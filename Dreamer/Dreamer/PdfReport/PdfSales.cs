...
namespace Dreamer.PdfReport
{
    public class PdfSales
    {
        ...
        List<SalesMasterView> _listReport = new List<SalesMasterView>();
        #endregion

      public byte[] Report(List<SalesMasterView> listReport)
        {
        ...
        private void ReportHeader()
        {
            ...
            _pdfCell = new PdfPCell(new Phrase("SalesInvoice List", _fontStyle));
