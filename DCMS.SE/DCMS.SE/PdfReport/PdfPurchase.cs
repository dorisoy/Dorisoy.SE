...
namespace DCMS.SE.PdfReport
{
    public class PdfPurchase
    {
        ...
        List<PurchaseMasterView> _listReport = new List<PurchaseMasterView>();
        #endregion

      public byte[] Report(List<PurchaseMasterView> listReport)
        {
        ...
        private void ReportHeader()
        {
            ...
            _pdfCell = new PdfPCell(new Phrase("PurchaseInvoice List", _fontStyle));
        ...
        private void ReportBody()
        {
            ...
            _pdfCell = new PdfPCell(new Phrase("Supplier", _fontStyle));
            _pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _pdfCell.BackgroundColor = BaseColor.Gray;
            _pdfTable.AddCell(_pdfCell);
