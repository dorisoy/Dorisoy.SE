    ...
    public class RptPurchase
    {
      ...
      public byte[] Report(List<ProductView> oStudents , Company company)
        ...
        private void ReportBody()
        {
            ...
            _pdfCell = new PdfPCell(new Phrase("Product Name", _fontStyle));
            _pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _pdfCell.BackgroundColor = BaseColor.Gray;
            _pdfTable.AddCell(_pdfCell);
            ...
            _pdfCell = new PdfPCell(new Phrase("Rate", _fontStyle));
            _pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _pdfCell.BackgroundColor = BaseColor.Gray;
            _pdfTable.AddCell(_pdfCell);
           ...
           foreach(var ostudent in _oStudents)
            {
                ...
                _pdfCell = new PdfPCell(new Phrase(ostudent.Qty.ToString(), _fontStyle));
                _pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                _pdfCell.BackgroundColor = BaseColor.White;
                _pdfTable.AddCell(_pdfCell);
