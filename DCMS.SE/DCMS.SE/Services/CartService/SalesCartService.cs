...
{
    public class SalesCartService : ICartSalesService
    {
        ...
        {
            var cart = await _localStorage.GetItemAsync<List<CartItem>>("salescart");
            if (cart == null)
            {
            ...
            await _localStorage.SetItemAsync("salescart", cart);
        ...
        {
            await _localStorage.RemoveItemAsync("salescart");
            //OnChange.Invoke();
        }
