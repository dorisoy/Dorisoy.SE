...
{
    public class PurchaseReturnCartService : IPurchaseReturnService
    {
        private readonly ILocalStorageService _localStorage;

        public event Action OnChange;

        public PurchaseReturnCartService(
        ...
        {
            var cart = await _localStorage.GetItemAsync<List<CartItem>>("prcart");
            if (cart == null)
            {
            ...
            await _localStorage.SetItemAsync("prcart", cart);
        ...
        {
            await _localStorage.RemoveItemAsync("prcart");
            //OnChange.Invoke();
        }
    }
}
